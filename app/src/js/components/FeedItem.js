...
var FeedItem = React.createClass({
    ...
    render: function() {
        var positiveNagativeClassName = this.props.voteCount >=0 ? "badge badge-success" : "badge badge-danger"
        return (
            <li className="list-group-item">
                  <span className={positiveNagativeClassName}>{this.props.voteCount}</span>
